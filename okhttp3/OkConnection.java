 ...
 * {@linkplain OkConnectionPool connection pool}.
 *
...
public interface OkConnection {
  ...
  /**
   * Returns the protocol negotiated by this connection, or {@link OkProtocol#HTTP_1_1} if no protocol
   * has been negotiated. This method returns {@link OkProtocol#HTTP_1_1} even if the remote peer is
   * using {@link OkProtocol#HTTP_1_0}.
   */
  OkProtocol protocol();
}
