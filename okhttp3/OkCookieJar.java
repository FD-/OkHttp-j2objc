 ...
 */
public interface OkCookieJar {
  /** A cookie jar that never accepts any cookies. */
  OkCookieJar NO_COOKIES = new OkCookieJar() {
   ...
   * cookies.
   */
  void saveFromResponse(OkHttpUrl url, List<OkCookie> cookies);
   ...
   * {@linkplain OkCookie#matches match} {@code url}.
   */
  List<OkCookie> loadForRequest(OkHttpUrl url);
}
