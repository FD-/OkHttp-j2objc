...
public final class OkCacheControl {
   ...
   */
  public static final OkCacheControl FORCE_NETWORK = new Builder().noCache().build();
   ...
   */
  public static final OkCacheControl FORCE_CACHE = new Builder()
      .onlyIfCached()
  ...
  private OkCacheControl(boolean noCache, boolean noStore, int maxAgeSeconds, int sMaxAgeSeconds,
  ...
  OkCacheControl(Builder builder) {
   ...
   */
  public static OkCacheControl parse(OkHeaders headers) {
    ...
    for (int i = 0, size = headers.size(); i < size; i++) {
      ...
      while (pos < value.length()) {
        int tokenStart = pos;
        pos = OkHttpHeaders.skipUntil(value, pos, "=,;");
        ...
        if (pos == value.length() || value.charAt(pos) == ',' || value.charAt(pos) == ';') {
          ...
          pos++; // consume '='
          pos = OkHttpHeaders.skipWhitespace(value, pos);
        ...
        if ("no-cache".equalsIgnoreCase(directive)) {
          ...
          maxAgeSeconds = OkHttpHeaders.parseSeconds(parameter, -1);
        } else if ("s-maxage".equalsIgnoreCase(directive)) {
          sMaxAgeSeconds = OkHttpHeaders.parseSeconds(parameter, -1);
          ...
          maxStaleSeconds = OkHttpHeaders.parseSeconds(parameter, Integer.MAX_VALUE);
        } else if ("min-fresh".equalsIgnoreCase(directive)) {
          minFreshSeconds = OkHttpHeaders.parseSeconds(parameter, -1);
    ...
    return new OkCacheControl(noCache, noStore, maxAgeSeconds, sMaxAgeSeconds, isPrivate, isPublic,
  ...
  public static final class Builder {
    ...
    public OkCacheControl build() {
      return new OkCacheControl(this);
    }
  }
}
