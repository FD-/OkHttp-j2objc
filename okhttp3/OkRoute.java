 ...
 */
public final class OkRoute {
  final OkAddress address;
  final Proxy proxy;
  final InetSocketAddress inetSocketAddress;

  public OkRoute(OkAddress address, Proxy proxy, InetSocketAddress inetSocketAddress) {
    if (address == null) {
   ...
   *
   * <strong>Warning:</strong> This may disagree with {@link OkAddress#proxy} when it is null. When
  ...
  @Override public boolean equals(Object other) {
    return other instanceof OkRoute
        && ((OkRoute) other).address.equals(address)
        && ((OkRoute) other).proxy.equals(proxy)
        && ((OkRoute) other).inetSocketAddress.equals(inetSocketAddress);
  }
