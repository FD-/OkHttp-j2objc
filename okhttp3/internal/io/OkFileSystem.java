 ...
 */
public interface OkFileSystem {
  /** The host machine's local file system. */
  OkFileSystem SYSTEM = new OkFileSystem() {
    @Override public OkioSource source(File file) throws FileNotFoundException {
      return Okio.source(file);
    }

    @Override public OkioSink sink(File file) throws FileNotFoundException {
      try {
    ...
    @Override public OkioSink appendingSink(File file) throws FileNotFoundException {
      try {
