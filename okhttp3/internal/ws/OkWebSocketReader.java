...
import static okhttp3.internal.ws.OkWebSocketProtocol.B0_FLAG_RSV1;
import static okhttp3.internal.ws.OkWebSocketProtocol.B0_FLAG_RSV2;
import static okhttp3.internal.ws.OkWebSocketProtocol.B0_FLAG_RSV3;
import static okhttp3.internal.ws.OkWebSocketProtocol.B0_MASK_OPCODE;
import static okhttp3.internal.ws.OkWebSocketProtocol.B1_FLAG_MASK;
import static okhttp3.internal.ws.OkWebSocketProtocol.B1_MASK_LENGTH;
import static okhttp3.internal.ws.OkWebSocketProtocol.CLOSE_NO_STATUS_CODE;
...
import static okhttp3.internal.ws.OkWebSocketProtocol.OPCODE_FLAG_CONTROL;
 ...
 */
final class OkWebSocketReader {
  public interface FrameCallback {
    void onReadMessage(String text) throws IOException;
    void onReadMessage(OkioByteString bytes) throws IOException;
    void onReadPing(OkioByteString buffer);
    void onReadPong(OkioByteString buffer);
  ...
  private final OkioBuffer controlFrameBuffer = new OkioBuffer();
  private final OkioBuffer messageFrameBuffer = new OkioBuffer();

  private final byte[] maskKey;
  private final OkioBuffer.UnsafeCursor maskCursor;

  OkWebSocketReader(boolean isClient, OkioBufferedSource source, FrameCallback frameCallback) {
    ...
    maskCursor = isClient ? null : new OkioBuffer.UnsafeCursor();
  }
    ...
    switch (opcode) {
      ...
      case OPCODE_CONTROL_CLOSE:
        ...
        if (bufferSize == 1) {
          ...
          String codeExceptionMessage = OkWebSocketProtocol.closeCodeExceptionMessage(code);
