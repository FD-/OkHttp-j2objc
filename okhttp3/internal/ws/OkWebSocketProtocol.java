...
public final class OkWebSocketProtocol {
  ...
  */
  ...
  static void toggleMask(OkioBuffer.UnsafeCursor cursor, byte[] key) {
    int keyIndex = 0;
  ...
  public static String acceptHeader(String key) {
    return OkioByteString.encodeUtf8(key + OkWebSocketProtocol.ACCEPT_MAGIC).sha1().base64();
  }

  private OkWebSocketProtocol() {
