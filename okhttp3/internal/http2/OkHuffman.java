...
class OkHuffman {
  ...
  private static final OkHuffman INSTANCE = new OkHuffman();

  public static OkHuffman get() {
    return INSTANCE;
  }
  ...
  void encode(OkioByteString data, OkioBufferedSink sink) throws IOException {
    long current = 0;
    int n = 0;
  ...
  int encodedLength(OkioByteString bytes) {
    long len = 0;
