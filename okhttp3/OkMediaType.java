 ...
 */
public final class OkMediaType {
  ...
  private OkMediaType(String mediaType, String type, String subtype, String charset) {
   ...
   */
  public static OkMediaType get(String string) {
    ...
    return new OkMediaType(string, type, subtype, charset);
  }
   ...
   */
  public static
  OkMediaType parse(String string) {
    try {
      return get(string);
  ...
  @Override public boolean equals(Object other) {
    return other instanceof OkMediaType && ((OkMediaType) other).mediaType.equals(mediaType);
  }
