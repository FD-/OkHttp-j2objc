...
public final class OkHeaders {
  ...
  OkHeaders(Builder builder) {
    this.namesAndValues = builder.namesAndValues.toArray(new String[builder.namesAndValues.size()]);
  }

  private OkHeaders(String[] namesAndValues) {
  ...
  public Date getDate(String name) {
    ...
    return value != null ? OkHttpDate.parse(value) : null;
  }
  ...
  @Override public boolean equals(Object other) {
    return other instanceof OkHeaders
        && Arrays.equals(((OkHeaders) other).namesAndValues, namesAndValues);
  }
   ...
   */
  public static OkHeaders of(String... namesAndValues) {
    ...
    return new OkHeaders(namesAndValues);
  }

  /**
   * Returns headers for the header names and values in the {@link Map}.
   */
  public static OkHeaders of(Map<String, String> headers) {
  ...
  public static final class Builder {
     ...
     */
    public Builder addAll(OkHeaders headers) {
    ...
    private void checkNameAndValue(String name, String value) {
      ...
      for (int i = 0, length = name.length(); i < length; i++) {
        ...
        if (c <= '\u0020' || c >= '\u007f') {
          throw new IllegalArgumentException(OkUtil.format(
    ...
    public OkHeaders build() {
      return new OkHeaders(this);
    }
  }
}
