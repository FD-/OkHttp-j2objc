...
public interface OkAuthenticator {
  ...
  OkAuthenticator NONE = new OkAuthenticator() {
    @Override public OkRequest authenticate(OkRoute route, OkResponse response) {
      return null;
    }
  };
  ...
  OkRequest authenticate(OkRoute route, OkResponse response) throws IOException;
}
