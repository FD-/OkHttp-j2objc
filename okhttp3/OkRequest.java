...
public final class OkRequest {
  ...
  OkRequest(Builder builder) {
    this.url = builder.url;
    this.method = builder.method;
    this.headers = builder.headers.build();
    this.body = builder.body;
    this.tags = OkUtil.immutableMap(builder.tags);
  }
  ...
  public static class Builder {
    ...
    public Builder() {
      this.method = "GET";
      this.headers = new OkHeaders.Builder();
    }

    Builder(OkRequest request) {
    ...
    public Builder url(OkHttpUrl url) {
     ...
     * exception by calling {@link OkHttpUrl#parse}; it returns null for invalid URLs.
     */
    ...
    public Builder url(URL url) {
      if (url == null) throw new NullPointerException("url == null");
      return url(OkHttpUrl.get(url.toString()));
    }
     ...
     */
    public Builder cacheControl(OkCacheControl cacheControl) {
    ...
    public Builder post(OkRequestBody body) {
      return method("POST", body);
    }

    public Builder delete(OkRequestBody body) {
      return method("DELETE", body);
    }

    public Builder delete() {
      return delete(OkUtil.EMPTY_REQUEST);
    }

    public Builder put(OkRequestBody body) {
      return method("PUT", body);
    }

    public Builder patch(OkRequestBody body) {
      return method("PATCH", body);
    }

    public Builder method(String method, OkRequestBody body) {
      if (method == null) throw new NullPointerException("method == null");
      if (method.length() == 0) throw new IllegalArgumentException("method.length() == 0");
      if (body != null && !OkHttpMethod.permitsRequestBody(method)) {
        throw new IllegalArgumentException("method " + method + " must not have a request body.");
      }
      if (body == null && OkHttpMethod.requiresRequestBody(method)) {
     ...
     * request using {@link OkRequest#tag}. Use null to remove any existing tag assigned for {@code
     * type}.
     *
