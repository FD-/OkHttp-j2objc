 ...
 * {@link OkioBufferedSource} which is both more efficient and more convenient. Use
 * {@link Okio#buffer(OkioSource)} to wrap any source with a buffer.
 *
 * <p>Sources are easy to test: just use a {@link OkioBuffer} in your tests, and
 ...
 * how many bytes they {@link OkioBufferedSource#require require}.
 *
 ...
 *
 * <p>And source has a stronger {@code skip} method: {@link OkioBufferedSource#skip}
 * won't return prematurely.
 *
 * <h3>Interop with InputStream</h3>
 * Use {@link Okio#source} to adapt an {@code InputStream} to a source. Use
 * {@link OkioBufferedSource#inputStream} to adapt a source to an {@code
 * InputStream}.
 */
public interface OkioSource extends Closeable {
  /**
   * Removes at least 1, and up to {@code byteCount} bytes from this and appends
   * them to {@code sink}. Returns the number of bytes read, or -1 if this
   * source is exhausted.
   */
  long read(OkioBuffer sink, long byteCount) throws IOException;
