...
final class OkioSegment {
  ...
  OkioSegment(byte[] data, int pos, int limit, boolean shared, boolean owner) {
    this.data = data;
    this.pos = pos;
    this.limit = limit;
    this.shared = shared;
   ...
   */
  OkioSegment sharedCopy() {
    shared = true;
    return new OkioSegment(data, pos, limit, true, false);
  }

  /** Returns a new segment that its own private copy of the underlying byte array. */
  OkioSegment unsharedCopy() {
    return new OkioSegment(data.clone(), pos, limit, false, true);
  }
  ...
  public
  OkioSegment pop() {
    OkioSegment result = next != this ? next : null;
    prev.next = next;
    next.prev = prev;
    next = null;
    prev = null;
   ...
   */
  public OkioSegment push(OkioSegment segment) {
    segment.prev = this;
    segment.next = next;
    next.prev = segment;
    next = segment;
   ...
   */
  public OkioSegment split(int byteCount) {
  ...
  public void compact() {
    ...
    pop();
    OkioSegmentPool.recycle(this);
  }

  /** Moves {@code byteCount} bytes from this segment to {@code sink}. */
  public void writeTo(OkioSegment sink, int byteCount) {
