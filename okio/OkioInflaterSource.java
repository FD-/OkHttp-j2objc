 ...
 */
public final class OkioInflaterSource implements OkioSource {
  ...
  public OkioInflaterSource(OkioSource source, Inflater inflater) {
   ...
   */
  OkioInflaterSource(OkioBufferedSource source, Inflater inflater) {
  ...
  @Override public long read(
          OkioBuffer sink, long byteCount) throws IOException {
    ...
    while (true) {
      ...
      try {
        ...
        int toRead = (int) Math.min(byteCount, OkioSegment.SIZE - tail.limit);
  ...
  public boolean refill() throws IOException {
    ...
    OkioSegment head = source.buffer().head;
