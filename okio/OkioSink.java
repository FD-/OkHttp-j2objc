 ...
 * {@link OkioBufferedSink} which is both more efficient and more convenient. Use
 * {@link Okio#buffer(OkioSink)} to wrap any sink with a buffer.
 *
 * <p>Sinks are easy to test: just use a {@link OkioBuffer} in your tests, and
 ...
 * OkioBufferedSink#outputStream} to adapt a sink to an {@code OutputStream}.
 */
public interface OkioSink extends Closeable, Flushable {
  /** Removes {@code byteCount} bytes from {@code source} and appends them to this. */
  void write(OkioBuffer source, long byteCount) throws IOException;
