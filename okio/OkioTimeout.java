...
public class OkioTimeout {
   ...
   * do not block.
   */
  public static final OkioTimeout NONE = new OkioTimeout() {
   ...
   */
  public OkioTimeout timeout(long timeout, TimeUnit unit) {
   ...
   */
  public OkioTimeout deadlineNanoTime(long deadlineNanoTime) {
  ...
  public final OkioTimeout deadline(long duration, TimeUnit unit) {
  ...
  public OkioTimeout clearTimeout() {
    this.timeoutNanos = 0;
    return this;
  }

  /** Clears the deadline. */
  public OkioTimeout clearDeadline() {
