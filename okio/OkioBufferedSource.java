 ...
 * input.
 */
public interface OkioBufferedSource extends OkioSource, ReadableByteChannel {
  ...
  OkioByteString readByteString(long byteCount) throws IOException;
   ...
   * }</pre>
   */
  int select(OkioOptions options) throws IOException;
   ...
   */
  void readFully(OkioBuffer sink, long byteCount) throws IOException;
   ...
   */
  long readAll(OkioSink sink) throws IOException;
  ...
  /** Equivalent to {@link #indexOf(OkioByteString, long) indexOf(bytes, 0)}. */
  long indexOf(OkioByteString bytes) throws IOException;
   ...
   * }</pre>
   */
  long indexOf(OkioByteString bytes, long fromIndex) throws IOException;

  /** Equivalent to {@link #indexOfElement(OkioByteString, long) indexOfElement(targetBytes, 0)}. */
  long indexOfElement(OkioByteString targetBytes) throws IOException;
   ...
   * }</pre>
   */
  long indexOfElement(OkioByteString targetBytes, long fromIndex) throws IOException;
   ...
   * }</pre>
   */
  boolean rangeEquals(long offset, OkioByteString bytes) throws IOException;
   ...
   */
  boolean rangeEquals(long offset, OkioByteString bytes, int bytesOffset, int byteCount)
      throws IOException;
